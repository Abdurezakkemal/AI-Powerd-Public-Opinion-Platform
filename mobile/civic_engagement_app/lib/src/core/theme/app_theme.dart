  ...
  static ThemeData light() {
    ...
    return ThemeData(
      ...
      bottomNavigationBarTheme: BottomNavigationBarThemeData(
        ...
        elevation: 0,
        selectedLabelStyle: const TextStyle(fontSize: 12, fontWeight: FontWeight.w800, height: 1.5),
        unselectedLabelStyle: const TextStyle(fontSize: 12, fontWeight: FontWeight.w600, height: 1.5),
